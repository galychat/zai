...
.fr.borderg {
    ...
    height:20.40px;
    border-bottom: 1px solid #294d4a;
    border-top: 1px solid #294d4a;
    border-Right: 1px solid #294d4a;
}
...
span.s1.fa.fa-user.label.badgex.label-as-badge.label-success {
    ...
    margin-left: -8px;
    font-size: 12px !important;color: #294d4a;
}
...
a.label.label-primary.fl {
    ...
    border: 0px solid #294d4a;
    font-family: 'jazeera-light',FontAwesome;
}
div#tlogins {
    border: 1px solid #294d4a;
    border-radius: 20px 20px 0px 0px;
outline: 0;
    border-color: #294d4a;
    outline: 0;
    -webkit-box-shadow: inset 0 2px 2px rgba(0,0,0,.075), 0 0 8px rgba(41,77,74);
    box-shadow: inset 0 2px 2px rgba(0,0,0,.075), 0 0 8px rgba(41,77,74);border: 1px solid #294d4a;
}
...
ul.nav.nav-tabs.fl li a {font-family: 'jazeera',FontAwesome;font-size: 15px!important;padding: 4px!important;text-align: center!important;border-radius: 0px;border-right: .50px solid #294d4a;color: #294d4a;width: 100%;color: #294d4a;}
ul.nav.nav-tabs.fl li a:hover {background-color: white;color: #294d4a;}
ul.nav.nav-tabs.fl li {width: 33.3%;
border-top: 2px solid #294d4a;
border-radius: 0px;
border-right: .50px solid #294d4a;
background-color: #FFFFFF;
border-bottom: 1px solid #294d4a;
...
div#l3 button, div#l1 button {background-color: #294d4a!important; border: 1px solid #ba3c66;  font-family: 'jazeera',FontAwesome; border: 1px solid #3B807A; border-radius: 30px 30px 30px 30px;}
div#l2 button {background-color: #294d4a!important; border: 1px solid #ba3c66;  font-family: 'jazeera',FontAwesome; border: 1px solid #3B807A;border-radius: 30px 30px 30px 30px;}



div#l1  input#u1 {border-radius: 15px 15px 0px 0px;border: 1px solid #294d4a;width: 99%;margin-top: 3px;margin-left:1px;text-align: center;font-family: 'jazeera-light',FontAwesome;}
...
div#l2 input#u2, div#l3 input#u3{margin-left: -6px;border-radius: 0px 15px 15px 0px;border: 1px solid #294d4a;}
...
div#l2 input#pass1, div#l3 input#pass2 {border-radius: 15px 0px 0px 15px;border: 1px solid #294d4a;}
...
ul.nav.nav-tabs.fl li  .fa-user:before,.fa-user-plus:before{float: left;background-image:none;background-color:#294d4a!important;padding: 2px 5px;margin-top: -5px;margin-left: -5px;font-size: 19px;}
...
#as43 {font-family: 'jazeera-light',FontAwesome;margin-bottom: 2px; background-color: #294d4a; height: 25px; color: #FFF; border-radius: 5px 5px 5px 5px; border-bottom: 2px solid #59D1C7; border-top: 2px solid #59D1C7; padding-bottom: 1px!important;}
...
.a {background-color: #FFFFFF; border-radius: 15px 15px 15px 15px; font-family: 'jazeera',FontAwesome; padding: 2px 10px 2px 10px; margin:7px 10px 7px 10px;color: #294d4a;}
