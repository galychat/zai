...
#as43 {font-family: 'jazeera-light',FontAwesome;margin-bottom: 2px; background-color: #F52887; height: 25px; color: #FFF; border-radius: 5px 5px 5px 5px; border-bottom: 2px solid #CA226B; border-top: 2px solid #CA226B; padding-bottom: 1px!important;}

#as8 {border-top: 2px solid #CA226B; border-bottom: 2px solid #CA226B; margin-bottom: 2px; border-radius: 10px 10px 10px 10px;}
#as7 {
    ...
    $.get('getonline', function(d) {
        ...
        $.each(data.online, function(i, e) {
            ...
            if (e.co == "--" || e.co == null || e.co == 'A1' || e.co == 'A2' || e.co == 'EU') {
                ...
                uh.find(".co").attr("src", "https://galychat.com/sico/z1cl5g72ao10.gif")
            }
            var ico = getico(e);
            if (ico != '') {
    ...
    $.get('getonline', function(C) {
        ...
        $.each(S.online, function(R, D) {
            if (!0 != D.s) {
                ...
                M.find('.ustat').remove(),
                '--' == D.co || null == D.co || 'A1' == D.co || 'A2' == D.co || 'EU' == D.co ? M.find('.co').remove() : M.find('.co').attr('src', 'https://galychat.com/sico/z1cl5g72ao10.gif');
                var A = getico(D);
